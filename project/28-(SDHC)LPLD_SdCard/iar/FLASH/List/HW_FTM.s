...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_FTM.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW509F.tmp
//        (G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_FTM.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\HW_FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_FTM.c
//    1 /**
//    2  * @file HW_FTM.c
...
??LPLD_FTM_PinInit_0:
        LDR.W    R0,??DataTable11  ;; 0x40039000
        CMP      R3,R0
...
//  981   if(ftmx == FTM0)
        LDR.W    R0,??DataTable14_28  ;; 0x40038000
        CMP      R2,R0
...
??LPLD_FTM_PinDeinit_4:
        LDR.N    R0,??DataTable14_10  ;; 0x4004901c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??LPLD_FTM_PinDeinit_0:
        LDR.N    R0,??DataTable11  ;; 0x40039000
        CMP      R2,R0
...
??DataTable14_29:
        ...
        DATA
?_0:
        DC8 "G:\\AIcar\\\344\277\241\346\240\207\\xiugai\\lib\\LPLD\\HW\\HW_FTM.c"

        END
// 
//    12 bytes in section .bss
//    44 bytes in section .rodata
// 3 922 bytes in section .text
// 
// 3 922 bytes of CODE  memory
