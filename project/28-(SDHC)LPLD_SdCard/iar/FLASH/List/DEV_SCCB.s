...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\Jay\DEV_SCCB.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW5AA1.tmp
//        (G:\AIcar\@@\xiugai\lib\Jay\DEV_SCCB.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\DEV_SCCB.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\Jay\DEV_SCCB.c
//    1 /*
//    2  *  
//    3  *  
...
//  200     //SCCB_DELAY();
//  201     SDA_DDR_IN();
        LDR.N    R4,??DataTable8_3  ;; 0x43fe02b4
        MOVS     R0,#+0
        STR      R0,[R4, #+0]
//  202 
//  203     while(i--)
