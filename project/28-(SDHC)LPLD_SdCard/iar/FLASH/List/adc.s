...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\Jay\adc.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW585C.tmp
//        (G:\AIcar\@@\xiugai\lib\Jay\adc.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\adc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  155   quotient *= IMG_COL_CENTER;
        LDR.N    R7,??DataTable3_19  ;; 0x429e0000
        MOVS     R1,R7
        BL       __aeabi_fmul
        MOVS     R6,R0
//  156   
...
??get_ind_error_3:
        ...
        LDR.N    R0,??DataTable3_23  ;; 0x3f333333
        MOVS     R1,R6
        BL       __aeabi_fmul
        BL       __aeabi_f2iz
        RSBS     R0,R0,#+79
