...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\CPU\system_MK60DZ10.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW6D6E.tmp
//        (G:\AIcar\@@\xiugai\lib\CPU\system_MK60DZ10.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\system_MK60DZ10.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\CPU\system_MK60DZ10.c
//    1 /**
...
//   85   g_bus_clock = g_core_clock / ((uint32_t)((SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV2_MASK) >> SIM_CLKDIV1_OUTDIV2_SHIFT)+ 1u);
        ...
        LDR.N    R0,??DataTable3_7  ;; 0x40048044
        LDR      R1,[R4, #+0]
        LDR      R2,[R0, #+0]
        UBFX     R2,R2,#+24,#+4
        ADDS     R2,R2,#+1
...
SystemCoreClockUpdate:
        ...
        ANDS     R1,R1,#0x1F
        ADDS     R1,R1,#+24
        LDR.N    R0,??DataTable3_20  ;; 0x2faf080
        MULS     R1,R0,R1
//  121   temp = (uint32_t)(temp/((uint32_t)(MCG->C5 & MCG_C5_PRDIV_MASK) +1u ));
        LDR.N    R0,??DataTable3_21  ;; 0x40064004
        LDRB     R0,[R0, #+0]
