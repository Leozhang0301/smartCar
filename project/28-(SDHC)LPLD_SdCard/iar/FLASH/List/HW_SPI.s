...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_SPI.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW59FF.tmp
//        (G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_SPI.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\HW_SPI.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_SPI.c
//    1 /**
//    2  * @file HW_SPI.c
...
//   87       PORTA->PCR[14] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_5  ;; 0x40049038
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_4
//   88     }
...
??LPLD_SPI_Init_3:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_6  ;; 0x4004b010
        STR      R1,[R2, #+0]
//   92     }
//   93     //选择PCS1
//   94     if(pcs1_pin == PTC3)
...
//   96       PORTC->PCR[3]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_7  ;; 0x4004b00c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_6
//   97     }
...
??LPLD_SPI_Init_5:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_8  ;; 0x4004c010
        STR      R1,[R2, #+0]
//  101     }
//  102     //选择PCS2
...
//  105       PORTC->PCR[2]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_9  ;; 0x4004b008
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_8
//  106     }
...
??LPLD_SPI_Init_7:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_10  ;; 0x4004c014
        STR      R1,[R2, #+0]
//  110     }
//  111     //选择PCS3
...
//  114       PORTC->PCR[1]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_11  ;; 0x4004b004
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_9:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_12  ;; 0x4004c018
        STR      R1,[R2, #+0]
//  119     }
//  120     //选择PCS4
...
//  123       PORTC->PCR[0]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_13  ;; 0x4004b000
        STR      R1,[R2, #+0]
//  124     }
//  125     //选择PCS5
...
//  128       PORTB->PCR[23] = 0 | PORT_PCR_MUX(3) | PORT_PCR_DSE_MASK;
        MOV      R1,#+832
        LDR.W    R2,??DataTable8_14  ;; 0x4004a05c
        STR      R1,[R2, #+0]
//  129     }
//  130 
//  131     //选择SCK
...
//  134       PORTA->PCR[15] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SCK
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_15  ;; 0x4004903c
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_13:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_16  ;; 0x4004b014
        STR      R1,[R2, #+0]
//  139     }
//  140     //选择MOSI
...
//  143       PORTA->PCR[16] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_17  ;; 0x40049040
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_15:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_18  ;; 0x4004b018
        STR      R1,[R2, #+0]
//  148     }
//  149     //选择MISO
...
//  152       PORTA->PCR[17] = 0 | PORT_PCR_MUX(2); //SIN
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_19  ;; 0x40049044
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_17:
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_20  ;; 0x4004b01c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
//  157     } 
//  158   
...
//  166       PORTB->PCR[10] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_22  ;; 0x4004a028
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_20:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_23  ;; 0x4004d010
        STR      R1,[R2, #+0]
//  171     }
//  172     //选择PCS1
...
//  175       PORTB->PCR[9]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_24  ;; 0x4004a024
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_22:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_25  ;; 0x4004d000
        STR      R1,[R2, #+0]
//  180     }
//  181     //选择PCS2
...
//  184       PORTE->PCR[5]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_26  ;; 0x4004d014
        STR      R1,[R2, #+0]
//  185     }
//  186 
//  187     //选择PCS3
...
//  190       PORTE->PCR[6]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_27  ;; 0x4004d018
        STR      R1,[R2, #+0]
//  191     }
//  192 
//  193     //选择SCK
...
//  196       PORTB->PCR[11] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_28  ;; 0x4004a02c
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_26:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_29  ;; 0x4004d008
        STR      R1,[R2, #+0]
//  201     }
//  202     //选择MOSI
...
//  205       PORTB->PCR[16] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_30  ;; 0x4004a040
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_28:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_31  ;; 0x4004d004
        STR      R1,[R2, #+0]
//  210     }
//  211     //选择MISO
...
//  214       PORTB->PCR[17] = 0 | PORT_PCR_MUX(2); //SIN
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_32  ;; 0x4004a044
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
//  215     }
...
??LPLD_SPI_Init_30:
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_33  ;; 0x4004d00c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
//  219     } 
//  220   }
...
//  227       PORTD->PCR[11] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_36  ;; 0x4004c02c
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_32:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_37  ;; 0x4004a050
        STR      R1,[R2, #+0]
//  232     }
//  233     //选择PCS1
...
//  236       PORTD->PCR[15]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_38  ;; 0x4004c03c
        STR      R1,[R2, #+0]
//  237     }
//  238 
//  239     //选择SCK
...
//  242       PORTD->PCR[12] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_39  ;; 0x4004c030
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_35:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_40  ;; 0x4004a054
        STR      R1,[R2, #+0]
//  247     }
//  248     //选择MOSI
...
//  251       PORTD->PCR[13] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_41  ;; 0x4004c034
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_37:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_42  ;; 0x4004a058
        STR      R1,[R2, #+0]
//  256     }
//  257     //选择MISO
...
//  260       PORTD->PCR[14] = 0 | PORT_PCR_MUX(2); //SIN
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_43  ;; 0x4004c038
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
//  261     }
...
??LPLD_SPI_Init_18:
        LDR.W    R1,??DataTable8_44  ;; 0x3f0c01
        STR      R1,[R4, #+0]
//  275   //选择SPI 工作模式
...
//  473     SIM->SCGC6 &= ~SIM_SCGC6_DSPI0_MASK;
        LDR.N    R0,??DataTable8_4  ;; 0x4004803c
        LDR      R1,[R0, #+0]
        BICS     R1,R1,#0x1000
        STR      R1,[R0, #+0]
...
??LPLD_SPI_EnableIrq_2:
        LDR.N    R0,??DataTable8_34  ;; 0x400ac000
        CMP      R4,R0
...
//  663   if( SPI0->SR & SPI_SR_TCF_MASK)
        LDR.N    R4,??DataTable8_49  ;; 0x4002c02c
        LDR      R0,[R4, #+0]
        CMP      R0,#+0
...
//  707   if( SPI1->SR & SPI_SR_TCF_MASK)
        LDR.N    R4,??DataTable8_50  ;; 0x4002d02c
        LDR      R0,[R4, #+0]
        CMP      R0,#+0
...
//  751   if( SPI2->SR & SPI_SR_TCF_MASK)
        LDR.N    R4,??DataTable8_51  ;; 0x400ac02c
        LDR      R0,[R4, #+0]
        CMP      R0,#+0
...
??DataTable8_51:
        ...
        DATA
?_0:
        DC8 "G:\\AIcar\\\344\277\241\346\240\207\\xiugai\\lib\\LPLD\\HW\\HW_SPI.c"
