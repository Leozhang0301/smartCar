...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_ADC.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW4A4E.tmp
//        (G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_ADC.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\HW_ADC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_ADC.c
//    1 /**
//    2  * @file HW_ADC.c
...
//  480           PORTD->PCR[chn-1] =  PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R4,??DataTable10_10  ;; 0x4004c000
        MOVS     R5,R1
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        ADD      R4,R4,R5, LSL #+2
        STR      R0,[R4, #-4]
...
??LPLD_ADC_Chn_Enable_7:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable10_11  ;; 0x4004a000
        MOVS     R5,R1
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        ADD      R4,R4,R5, LSL #+2
        STR      R0,[R4, #-32]
...
??LPLD_ADC_Chn_Enable_8:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable10_12  ;; 0x40049000
        MOVS     R5,R1
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        ADD      R4,R4,R5, LSL #+2
        STR      R0,[R4, #-12]
...
??LPLD_ADC_Chn_Enable_10:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable10_13  ;; 0x4004b000
        MOVS     R5,R1
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        ADD      R4,R4,R5, LSL #+2
        STR      R0,[R4, #-56]
...
??LPLD_ADC_Chn_Enable_12:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable10_14  ;; 0x4004d000
        MOVS     R5,R1
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        ADD      R4,R4,R5, LSL #+2
        STR      R0,[R4, #+28]
...
??DataTable10_14:
        ...
        DATA
?_0:
        DC8 "G:\\AIcar\\\344\277\241\346\240\207\\xiugai\\lib\\LPLD\\HW\\HW_ADC.c"
