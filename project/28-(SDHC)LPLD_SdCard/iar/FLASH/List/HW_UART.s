...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_UART.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW5BF5.tmp
//        (G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_UART.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\HW_UART.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_UART.c
//    1 /**
//    2  * @file HW_UART.c
...
//   61   if(uartx == UART0)
??LPLD_UART_Init_0:
        LDR.W    R6,??DataTable10_2  ;; 0x4006a000
        CMP      R1,R6
...
//   68       PORTA->PCR[2] = PORT_PCR_MUX(2); 
        MOV      R12,#+512
        LDR.W    LR,??DataTable10_5  ;; 0x40049008
        STR      R12,[LR, #+0]
...
//   70       PORTA->PCR[14] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_6  ;; 0x40049038
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_3
//   71     else
...
??LPLD_UART_Init_4:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_7  ;; 0x4004a044
        STR      R12,[LR, #+0]
//   73     
//   74     if(rx_pin == PTA1)
??LPLD_UART_Init_3:
...
//   75       PORTA->PCR[1] = PORT_PCR_MUX(2); 
        MOV      R12,#+512
        LDR.W    LR,??DataTable10_8  ;; 0x40049004
        STR      R12,[LR, #+0]
...
//   77       PORTA->PCR[15] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_9  ;; 0x4004903c
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//   78     else
...
??LPLD_UART_Init_7:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_10  ;; 0x4004a040
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//   80   }
//   81   else
...
//   83     if (uartx == UART1)
??LPLD_UART_Init_1:
        LDR.W    R6,??DataTable10_11  ;; 0x4006b000
        CMP      R1,R6
...
//   90         PORTE->PCR[0] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_12  ;; 0x4004d000
        STR      R12,[LR, #+0]
...
??LPLD_UART_Init_9:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_13  ;; 0x4004b010
        STR      R12,[LR, #+0]
//   93       
//   94       if(rx_pin == PTE1)
??LPLD_UART_Init_10:
...
//   95         PORTE->PCR[1] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_14  ;; 0x4004d004
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//   96       else
...
??LPLD_UART_Init_11:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_15  ;; 0x4004b00c
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//   98     }
//   99     else
...
??LPLD_UART_Init_8:
        LDR.W    R6,??DataTable10_16
        LDR      R6,[R6, #+0]
//  102       if (uartx == UART2)
        LDR.W    R7,??DataTable10_17  ;; 0x4006c000
        CMP      R1,R7
...
//  107         PORTD->PCR[3] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_18  ;; 0x4004c00c
        STR      R12,[LR, #+0]
//  108         PORTD->PCR[2] = PORT_PCR_MUX(3);
        LDR.W    LR,??DataTable10_19  ;; 0x4004c008
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  109       }
//  110       else
...
//  112         if(uartx == UART3)
??LPLD_UART_Init_12:
        LDR.W    R7,??DataTable10_20  ;; 0x4006d000
        CMP      R1,R7
...
//  118             PORTE->PCR[4] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_21  ;; 0x4004d010
        STR      R12,[LR, #+0]
...
//  120             PORTB->PCR[11] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_22  ;; 0x4004a02c
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_15
//  121           else 
...
??LPLD_UART_Init_16:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_23  ;; 0x4004b044
        STR      R12,[LR, #+0]
//  123           
//  124           if(rx_pin == PTE5)
??LPLD_UART_Init_15:
...
//  125             PORTE->PCR[5] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_24  ;; 0x4004d014
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
...
//  127             PORTB->PCR[10] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_25  ;; 0x4004a028
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  128           else
...
??LPLD_UART_Init_18:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_26  ;; 0x4004b040
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  130         }
//  131         else
...
//  133           if(uartx == UART4)
??LPLD_UART_Init_13:
        LDR.W    R7,??DataTable10_27  ;; 0x400ea000
        CMP      R1,R7
...
//  139               PORTE->PCR[24] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_29  ;; 0x4004d060
        STR      R12,[LR, #+0]
...
??LPLD_UART_Init_20:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_30  ;; 0x4004b03c
        STR      R12,[LR, #+0]
//  142             
//  143             if(rx_pin == PTE25)
??LPLD_UART_Init_21:
...
//  144               PORTE->PCR[25] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_31  ;; 0x4004d064
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  145             else
...
??LPLD_UART_Init_22:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_32  ;; 0x4004b038
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  147           }
//  148           else
...
??LPLD_UART_Init_19:
        MOVS     R7,#+5
//  151             uartx = UART5;
        LDR.W    R12,??DataTable10_33  ;; 0x400eb000
        MOV      R1,R12
...
//  155               PORTD->PCR[9] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_34  ;; 0x4004c024
        STR      R12,[LR, #+0]
...
??LPLD_UART_Init_23:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_35  ;; 0x4004d020
        STR      R12,[LR, #+0]
//  158             
//  159             if(rx_pin == PTD8)
??LPLD_UART_Init_24:
...
//  160               PORTD->PCR[8] = PORT_PCR_MUX(3); 
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_36  ;; 0x4004c020
        STR      R12,[LR, #+0]
        B.N      ??LPLD_UART_Init_6
//  161             else
...
??LPLD_UART_Init_25:
        MOV      R12,#+768
        LDR.W    LR,??DataTable10_37  ;; 0x4004d024
        STR      R12,[LR, #+0]
//  163           }
//  164         }
//  165       }
