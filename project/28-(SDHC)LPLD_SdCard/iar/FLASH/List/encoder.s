...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\encoder.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  152   gpioSpeed=0;
        ...
        STR      R0,[R3, #+0]
//  153   if(1==PTA8_I)
        LDR.N    R0,??DataTable9_11  ;; 0x43fe0220
        LDR      R3,[R0, #+0]
        CMP      R3,#+1
        BNE.N    ??getspeed_0
//  154   {return -val;}
...
//  177   val=10*LPLD_FTM_GetCounter(FTM1);
        LDR.N    R6,??DataTable9_7  ;; 0x40039000
        MOVS     R0,R6
...
//  186   val=10*LPLD_FTM_GetCounter(FTM2);
        LDR.N    R6,??DataTable9_1  ;; 0x400b8000
        MOVS     R0,R6
        BL       LPLD_FTM_GetCounter
        MOVS     R1,#+10
        SMULBB   R5,R0,R1
