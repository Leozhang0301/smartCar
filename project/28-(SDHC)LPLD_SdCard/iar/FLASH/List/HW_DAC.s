...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_DAC.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW4C15.tmp
//        (G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_DAC.c -D LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\xiugai\project\28-(SDHC)LPLD_SdCard\iar\FLASH\List\HW_DAC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\xiugai\lib\LPLD\HW\HW_DAC.c
//    1 /**
//    2  * @file HW_DAC.c
...
//  307   if((DAC0->SR & DAC_SR_DACBFRPBF_MASK) && (DAC0->C0 & DAC_C0_DACBBIEN_MASK))
        LDR.N    R4,??DataTable9_9  ;; 0x400cc020
        LDRB     R0,[R4, #+0]
        LSLS     R0,R0,#+31
...
//  343   if((DAC1->SR & DAC_SR_DACBFRPBF_MASK) && (DAC1->C0 & DAC_C0_DACBBIEN_MASK))
        LDR.N    R4,??DataTable9_11  ;; 0x400cd020
        LDRB     R0,[R4, #+0]
        LSLS     R0,R0,#+31
...
??DataTable9_12:
        ...
        DATA
?_0:
        DC8 "G:\\AIcar\\\344\277\241\346\240\207\\xiugai\\lib\\LPLD\\HW\\HW_DAC.c"
