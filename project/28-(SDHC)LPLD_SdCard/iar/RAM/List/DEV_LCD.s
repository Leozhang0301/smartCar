///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.32.1.169/W32 for ARM        18/May/2019  16:18:11
// Copyright 1999-2018 IAR Systems AB.
//
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\DEV\DEV_LCD.c
//    Command line =  
//        -f C:\Users\TEMPLA~1.000\AppData\Local\Temp\EW654E.tmp
//        (C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\DEV\DEV_LCD.c -D
//        LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\project\28-(SDHC)LPLD_SdCard\iar\RAM\List\DEV_LCD.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   99   ptc_init.GPIO_PTx = PTC;
        LDR.W    R0,??DataTable20  ;; 0x400ff080
        STR      R0,[SP, #+4]
...
LPLD_LCD_WriteData:
        LDR.W    R1,??DataTable20_1  ;; 0x60010000
        STRH     R0,[R1, #+0]
//  123 }
        BX       LR               ;; return
//  124 
...
LPLD_LCD_ReadData:
        LDR.W    R0,??DataTable20_1  ;; 0x60010000
        LDRH     R0,[R0, #+0]
//  133   return value;
...
LPLD_LCD_Reset:
        PUSH     {R4,LR}
//  188   LCD_CLR_RST;
        LDR.W    R4,??DataTable20_3  ;; 0x43fe104c
        MOVS     R0,#+0
        STR      R0,[R4, #+0]
...
//  673   if(side_xlength > MAX_X || side_ylength > MAX_Y)
        ...
        UXTH     R2,R2            ;; ZeroExt  R2,R2,#+16,#+16
        CMP      R2,R1
        BGE.N    ??LPLD_LCD_DrawRectangle_0
        MOV      R2,R8
        UXTH     R2,R2            ;; ZeroExt  R2,R2,#+16,#+16
        CMP      R2,#+241
