...
//    Endian       =  little
//    Source file  =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\HW\HW_RTC.c
//    Command line =  
//        -f C:\Users\TEMPLA~1.000\AppData\Local\Temp\EW8C07.tmp
//        (C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\HW\HW_RTC.c -D
//        LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\project\28-(SDHC)LPLD_SdCard\iar\RAM\List\HW_RTC.s
//
///////////////////////////////////////////////////////////////////////////////
...
??LPLD_RTC_Init_2:
        LDR.N    R4,??DataTable4_3  ;; 0x4003d01c
        LDR      R5,[R4, #+0]
        LSRS     R5,R5,#+1
        LSLS     R5,R5,#+1
        STR      R5,[R4, #+0]
