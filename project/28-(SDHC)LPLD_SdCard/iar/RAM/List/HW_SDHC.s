...
//    Endian       =  little
//    Source file  =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\HW\HW_SDHC.c
//    Command line =  
//        -f C:\Users\TEMPLA~1.000\AppData\Local\Temp\EW8ED7.tmp
//        (C:\Users\que\Desktop\AAA_xinbiao\smartcar\lib\LPLD\HW\HW_SDHC.c -D
//        LPLD_K60 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\que\Desktop\AAA_xinbiao\smartcar\project\28-(SDHC)LPLD_SdCard\iar\RAM\List\HW_SDHC.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  168   SDHC->SYSCTL = SDHC_SYSCTL_RSTA_MASK | SDHC_SYSCTL_SDCLKFS(0x80);
        LDR.W    R5,??DataTable8_6  ;; 0x400b102c
...
??LPLD_SDHC_Init_1:
        LDR.W    R6,??DataTable8_7  ;; 0x400b1024
        LDR      R0,[R6, #+0]
        TST      R0,#0x3
...
//  193         | SDHC_IRQSTATEN_TCSEN_MASK | SDHC_IRQSTATEN_CCSEN_MASK;
        LDR.W    R1,??DataTable10_3  ;; 0x7f00b3
        LDR.W    R2,??DataTable10_4  ;; 0x400b1034
        STR      R1,[R2, #+0]
//  194   
//  195   //等待80个初始时钟
...
??LPLD_SDHC_SendCommand_4:
        LDR.W    R6,??DataTable10  ;; 0x400b1030
        LDR      R1,[R6, #+0]
        ORRS     R1,R1,#0x80
        STR      R1,[R6, #+0]
//  264   
...
//  300     command->RESPONSE[0] = SDHC->CMDRSP[0];
        LDR.W    R0,??DataTable10_9  ;; 0x400b1010
        LDR      R0,[R0, #+0]
        STR      R0,[R4, #+16]
...
//  303       command->RESPONSE[1] = SDHC->CMDRSP[1];
        LDR.W    R0,??DataTable10_10  ;; 0x400b1014
        LDR      R0,[R0, #+0]
        STR      R0,[R4, #+20]
//  304       command->RESPONSE[2] = SDHC->CMDRSP[2];
        LDR.W    R0,??DataTable10_11  ;; 0x400b1018
        LDR      R0,[R0, #+0]
        STR      R0,[R4, #+24]
//  305       command->RESPONSE[3] = SDHC->CMDRSP[3];
        LDR.W    R0,??DataTable11  ;; 0x400b101c
        LDR      R0,[R0, #+0]
        STR      R0,[R4, #+28]
//  306     }
//  307   }
...
??LPLD_SDHC_IOC_0:
        LDR.W    R1,??DataTable11_1  ;; 0x61a80
...
??LPLD_SDHC_IOC_11:
        LDR.W    R0,??DataTable11_3  ;; 0x81a0000
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_IOC_13:
        LDR.W    R11,??DataTable11_4  ;; 0x5020000
        STR      R11,[SP, #+0]
...
//  431       command.COMMAND = ESDHC_CMD55;
        LDR.W    R0,??DataTable11_5  ;; 0x371a0000
        STR      R0,[SP, #+0]
...
//  447         command.ARGUMENT = 0x40300000;
        LDR.W    R0,??DataTable11_6  ;; 0x40300000
        STR      R0,[SP, #+4]
...
//  460         command.COMMAND = ESDHC_CMD39;
        LDR.W    R10,??DataTable11_7  ;; 0x27020000
        STR      R10,[SP, #+0]
...
??LPLD_SDHC_IOC_26:
        LDR.W    R11,??DataTable11_8  ;; 0x29020000
        STR      R11,[SP, #+0]
...
//  583     LPLD_SDHC_SetBaudrate (g_core_clock*1000, 25000000);
        LDR.W    R1,??DataTable11_9  ;; 0x17d7840
        LDR.W    R0,??DataTable11_2
        LDR      R0,[R0, #+0]
        MOV      R2,#+1000
        MULS     R0,R2,R0
...
??LPLD_SDHC_Read_3:
        LDR.W    R3,??DataTable11_10  ;; 0x400b1020
        LDR      R3,[R3, #+0]
        STR      R3,[R2, #+0]
//  786       data_ptr += 4;
        ADDS     R2,R2,#+4
...
//  885       SDHC->DATPORT = *((uint32 *)udata_ptr);
        LDR      R3,[R2, #+0]
        LDR.W    R4,??DataTable11_10  ;; 0x400b1020
        STR      R3,[R4, #+0]
//  886       udata_ptr += 4;
        ADDS     R2,R2,#+4
//  887       remains -= 4;
...
??LPLD_SDHC_Write_11:
        LDR.N    R2,??DataTable8_7  ;; 0x400b1024
        LDR      R2,[R2, #+0]
        LSLS     R2,R2,#+21
...
??LPLD_SDHC_InitCard_8:
        LDR.W    R0,??DataTable11_11  ;; 0x2090000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_11:
        LDR.W    R0,??DataTable11_12  ;; 0x31a0000
        STR      R0,[SP, #+4]
...
// 1038   command.COMMAND = ESDHC_CMD9;
        LDR.N    R0,??DataTable11_13  ;; 0x9090000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_15:
        LDR.N    R0,??DataTable11_9  ;; 0x17d7840
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_InitCard_16:
        LDR.N    R0,??DataTable11_14  ;; 0x71b0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_17:
        LDR.N    R0,??DataTable11_15  ;; 0x101a0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_18:
        LDR.N    R0,??DataTable11_5  ;; 0x371a0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_19:
        LDR.N    R0,??DataTable11_16  ;; 0x61a0000
        STR      R0,[SP, #+4]
...
// 1144     command.COMMAND = ESDHC_CMD18;
        LDR.N    R0,??DataTable11_17  ;; 0x121a0034
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_ReadBlocks_1:
        LDR.N    R0,??DataTable11_18  ;; 0x111a0010
        STR      R0,[SP, #+0]
// 1149   }
// 1150   
...
// 1208         command.COMMAND = ESDHC_CMD25;
        LDR.N    R0,??DataTable11_20  ;; 0x191a0024
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_WriteBlocks_1:
        LDR.N    R0,??DataTable11_21  ;; 0x181a0000
        STR      R0,[SP, #+4]
// 1213     }
// 1214 
...
??LPLD_SDHC_WriteBlocks_9:
        LDR      R0,[SP, #+20]
        LDR.N    R1,??DataTable11_22  ;; 0xffd98008
        TST      R0,R1
...
??LPLD_SDHC_WriteBlocks_8:
        LDR.N    R0,??DataTable11_23  ;; 0xd1a0000
        STR      R0,[SP, #+4]
        LDR      R0,[R6, #+0]
        LDR      R0,[R0, #+12]
        STR      R0,[SP, #+8]
...
??LPLD_SDHC_WriteBlocks_14:
        LDR.N    R0,??DataTable11_24  ;; 0x161a0010
        STR      R0,[SP, #+4]
