...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_I2C.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW3671.tmp
//        (G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_I2C.c -D LPLD_K60
//        -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\k60_144\smartcar\project\28-(SDHC)LPLD_SdCard\iar\BOOT\List\HW_I2C.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_I2C.c
//    1 /*
//    2  * @file HW_I2C.c
...
??LPLD_I2C_Init_2:
        ...
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ORRS     R1,R1,#0x600
        LDR.N    R2,??DataTable7_13  ;; 0x4004d004
        STR      R1,[R2, #+0]
...
??LPLD_I2C_Init_13:
        ...
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ORRS     R1,R1,#0x200
        LDR.N    R2,??DataTable7_14  ;; 0x4004b028
        STR      R1,[R2, #+0]
??LPLD_I2C_Init_14:
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
        CMP      R7,#+124
