...
//    Cpu mode     =  
//    Endian       =  little
//    Source file  =  G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_SPI.c
//    Command line =  
//        -f C:\Users\admin\AppData\Local\Temp\EW3D6E.tmp
//        (G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_SPI.c -D LPLD_K60
//        -lCN
...
//    Locale       =  C
//    List file    =  
//        G:\AIcar\@@\k60_144\smartcar\project\28-(SDHC)LPLD_SdCard\iar\BOOT\List\HW_SPI.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\AIcar\@@\k60_144\smartcar\lib\LPLD\HW\HW_SPI.c
//    1 /**
//    2  * @file HW_SPI.c
...
??LPLD_SPI_Init_18:
        LDR.W    R1,??DataTable8_20  ;; 0x3f0c01
        STR      R1,[R4, #+0]
//  275   //选择SPI 工作模式
...
??LPLD_SPI_Init_17:
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_21  ;; 0x4004b01c
        STR      R1,[R2, #+0]
...
??LPLD_SPI_Init_2:
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_23  ;; 0x4004a028
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_23
??LPLD_SPI_Init_22:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_24  ;; 0x4004d010
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_23:
        LDRB     R1,[SP, #+1]
        CMP      R1,#+41
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_25  ;; 0x4004a024
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_25
??LPLD_SPI_Init_24:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_26  ;; 0x4004d000
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_25:
        LDRB     R1,[SP, #+7]
        CMP      R1,#+129
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_27  ;; 0x4004d014
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_26:
        LDRB     R1,[SP, #+6]
        CMP      R1,#+130
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_28  ;; 0x4004d018
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_27:
        LDRB     R1,[SP, #+3]
        CMP      R1,#+43
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_29  ;; 0x4004a02c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_29
??LPLD_SPI_Init_28:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_30  ;; 0x4004d008
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_29:
        LDRB     R1,[SP, #+4]
        CMP      R1,#+48
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_31  ;; 0x4004a040
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_31
??LPLD_SPI_Init_30:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_32  ;; 0x4004d004
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_31:
        LDRB     R1,[SP, #+5]
        CMP      R1,#+49
        ...
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_33  ;; 0x4004a044
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
??LPLD_SPI_Init_32:
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_34  ;; 0x4004d00c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
??LPLD_SPI_Init_21:
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_37  ;; 0x4004c02c
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_35
??LPLD_SPI_Init_34:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_38  ;; 0x4004a050
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_35:
        LDRB     R1,[SP, #+1]
        CMP      R1,#+107
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_39  ;; 0x4004c03c
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_36:
        LDRB     R1,[SP, #+3]
        CMP      R1,#+104
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_40  ;; 0x4004c030
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_38
??LPLD_SPI_Init_37:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_41  ;; 0x4004a054
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_38:
        LDRB     R1,[SP, #+4]
        CMP      R1,#+105
        ...
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_42  ;; 0x4004c034
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_40
??LPLD_SPI_Init_39:
        MOV      R1,#+576
        LDR.W    R2,??DataTable8_43  ;; 0x4004a058
        STR      R1,[R2, #+0]
??LPLD_SPI_Init_40:
        LDRB     R1,[SP, #+5]
        CMP      R1,#+106
        ...
        MOV      R1,#+512
        LDR.W    R2,??DataTable8_44  ;; 0x4004c038
        STR      R1,[R2, #+0]
        B.N      ??LPLD_SPI_Init_18
??LPLD_SPI_Init_41:
        MOV      R1,#+512
...
??LPLD_SPI_EnableIrq_3:
        LDR.N    R1,??DataTable8_35  ;; 0x400ac000
        CMP      R0,R1
